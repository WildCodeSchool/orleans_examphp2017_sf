...
class EquipeController extends Controller
{
    ...
    public function newAction(Request $request)
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            $em = $this->getDoctrine()->getManager();
            $data = $form->getData();
//            $joueurs = $em->getRepository('QuidditchBundle\Entity\Joueur')->findByExperience($data['experience']);
//            $joueurs = $em->getRepository('QuidditchBundle\Entity\Joueur')->findByAge($data['age']);
//            $joueurs = $em->getRepository('QuidditchBundle\Entity\Joueur')->findByFatigue($data['fatigue']);
